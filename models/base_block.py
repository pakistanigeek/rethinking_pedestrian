...
class FeatClassifier(nn.Module):
    ...
    def forward(self, x, label=None):
        feat_map,repeat_2, repeat, conv2d_4a = self.backbone(x)

        fusion_5b = self.latlayer_5b(repeat_2)
        fusion_4d = self._upsample_add(fusion_5b, self.latlayer_4d(repeat))
        fusion_3b = self._upsample_add(fusion_4d, self.latlayer_3b(conv2d_4a))
