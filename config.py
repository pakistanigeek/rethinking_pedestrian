...
def argument_parser():
    ...
    parser.add_argument("--lr_ft", type=float, default=0.001, help='learning rate of feature extractor')
    ...
    parser.add_argument("--valid_split", type=str, default="test", choices=['test', 'val'])
